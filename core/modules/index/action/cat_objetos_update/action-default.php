<?php
$objeto = ViewObjectData::getById($_POST['vwiId']);
$processFallo = false;
$msj = '';
if ($objeto->AbrirTransaccion() == false) {
    ...
    $addBit->biaccion = "'Usuario " . UserData::getById($_SESSION['user_id'])->usr_user . " , realiza actualizacion de registro : " . $objeto->vwi_codigo. " '";

<?php
$pais = PaisData::getById($_POST['paiId']);
$processFallo = false;
$msj = '';
if ($pais->AbrirTransaccion() == false) {
    ...
    $addBit->biaccion = "'Usuario " . UserData::getById($_SESSION['user_id'])->usr_user . " , realiza actualizacion de registro : " . $pais->pai_id. " '";

if (document.getElementById('factIngreso')) {
    $(document).ready(function () {
                    ...
                    success: function (res) {
                        ...
                        $.each(d.data, function (i, item) {
                            ...
                            op += '<td>' + item.codigo + '<input type="hidden" name="iniva" value="' + item.iniva + '"></td>' +
                                ...
                                '<td><input type="hidden" value="">' + item.subtotal + '</td>' +
            ...
            function procesarCompra() {
                ...
                if (validaDataForFacturacion(cliente) === "") {
                    ...
                    *               ITERACION DE FORMA DE PAGO */
                    ...
                    $.ajax({
                        url: './?action=processFacturacionIngreso',
                        method: "POST",
                        data: formData,
            ...
            function proccessRetencion(idFiles) {
                $.ajax({
                    ...
                    beforeSend: function () {
                        $("#myModalLoadingRennvio").modal('show')
                        $("#loading").addClass('loading');
                    },
                    success: function (data) {
                        ...
                        if (r.error == '') {
                            if (r.msj[0].msjAuto.substr(0, 1) == 1) {
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',

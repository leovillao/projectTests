if (document.getElementById('newpedido')) {
    $(document).ready(function () {
        ...
        xhttp.open("GET", './?action=processNewPedido&option=10')
        xhttp.send()
        ...
        function procesarCompra(tipoProcesso) {
            ...
            $.ajax({
                url: './?action=ve_processNewPedido',
                method: "POST",
                data: formData,
        ...
        function loadProductForBodega() {
            ...
            xhttpLimit.open("GET", './?action=processNewPedido&option=11&bodega=')
            xhttpLimit.send()
        }

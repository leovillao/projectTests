            ...
            function loadPedidosData(numPedido) {
                ...
                $.post("./?action=loadPedforEdit", {pedido: numPedido})
                    .done(function (data) {
                        ...
                        $.each(r, function (i, item) {
                            htmlTable += "<tr>"
                            htmlTable += "<td><input type='hidden' name='iniva' value='" + item.iniva + "'>" + item.codigo + "</td><td>" + item.producto + "</td><td><input class='form-control cantPedDet' id='"+item.id+"' size='4' type='number' value='" + item.cantidad + "'></td><td><input type='hidden' name='unidad' value='" + item.unidadDigitada + "'>" + item.unidadDigitadaName + "</td><td><input type='hidden' value='0'>" + item.precio + "</td><td><input type='hidden' value='0'>" + parseFloat(item.cantidad * item.precio).toFixed(5) + "</td><td>" + item.total + "</td><td></td>"
                            htmlTable += "</tr>"

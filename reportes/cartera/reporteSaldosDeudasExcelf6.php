...
$where .= " order by a.veid,a.tdid,a.deid asc";
...
$hoja->setCellValueByColumnAndRow(3, 3, 'Vendedor');
$hoja->setCellValueByColumnAndRow(4, 3, 'Documento');
$hoja->setCellValueByColumnAndRow(5, 3, 'Tipo');
$hoja->setCellValueByColumnAndRow(6, 3, 'Cliente');
$hoja->setCellValueByColumnAndRow(7, 3, 'Total');
$hoja->setCellValueByColumnAndRow(8, 3, 'Abono');
$hoja->setCellValueByColumnAndRow(9, 3, 'Saldo');
$hoja->setCellValueByColumnAndRow(10, 3, 'Fecha Venc');
$hoja->setCellValueByColumnAndRow(11, 3, 'Dias Venc');
...
foreach ($cobros as $cobro) {
    ...
    $hoja->setCellValueByColumnAndRow(2, $i, $cobro->deid);
    $hoja->setCellValueByColumnAndRow(3, $i, $cobro->venombre);
    ...
    $hoja->setCellValueByColumnAndRow(7, $i, $cobro->detotal);
    $hoja->setCellValueByColumnAndRow(8, $i, $cobro->deabono);
    $hoja->setCellValueByColumnAndRow(9, $i, $cobro->desaldo);
    $hoja->setCellValueByColumnAndRow(10, $i, $cobro->devence);
    $hoja->setCellValueByColumnAndRow(11, $i, ($cobro->vencidos > 0 && $cobro->desaldo > 0)?$cobro->vencidos:'');
    $i++;
    $o++;
}

...
$where .= " order by vencidos,a.ceid,deid asc";
...
$spread->getActiveSheet()->mergeCells('A1:H1');
...
$hoja->setCellValueByColumnAndRow(1, 3, 'Dias Venc');
$hoja->setCellValueByColumnAndRow(2, 3, 'Fecha Venc');
$hoja->setCellValueByColumnAndRow(3, 3, 'Fecha');
$hoja->setCellValueByColumnAndRow(4, 3, 'Doc');
$hoja->setCellValueByColumnAndRow(5, 3, 'Cliente');
$hoja->setCellValueByColumnAndRow(6, 3, 'Documento');
$hoja->setCellValueByColumnAndRow(8, 3, 'Total');
$hoja->setCellValueByColumnAndRow(9, 3, 'Abono');
$hoja->setCellValueByColumnAndRow(10, 3, 'Saldo');
$i = 4;
$o = 0;
$t = 1;
foreach ($cobros as $cobro) {
//    $hoja->setCellValueByColumnAndRow(1, $i, $cobro->defecha);
    $hoja->setCellValueByColumnAndRow(1, $i, ($cobro->vencidos > 0 && $cobro->desaldo > 0)?$cobro->vencidos:'');
    $hoja->setCellValueByColumnAndRow(2, $i, $cobro->devence);
    $hoja->setCellValueByColumnAndRow(3, $i, $cobro->defecha);
    $hoja->setCellValueByColumnAndRow(4, $i, $cobro->deid);
    $hoja->setCellValueByColumnAndRow(5, $i, $cobro->tdnombre);
    $hoja->setCellValueByColumnAndRow(6, $i, ucwords(strtolower($cobro->cename)));
    $hoja->setCellValueByColumnAndRow(7, $i, $cobro->derefer);
    $hoja->setCellValueByColumnAndRow(8, $i, $cobro->detotal);
    $hoja->setCellValueByColumnAndRow(9, $i, $cobro->deabono);
    $hoja->setCellValueByColumnAndRow(10, $i, $cobro->desaldo);
    $i++;
    $o++;
}
$fileName = "InformeSaldoPorDocumentof3.xlsx";
# Crear un "escritor"

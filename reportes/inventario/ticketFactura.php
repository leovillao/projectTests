...
//$pdf->Ln(3);
//$pdf->setX(7);
$pdf->Cell(60, 4, 'Factura # : ', 0, 1, 'L', 0, 1);
...
//  $pdf->Cell(25, 3, $productos[$i]['name'], 0, 0, 'L', 0, 1);
    ...
    $pdf->Cell(35, 3, number_format($productos[$i]['cantidad'], $numDecimales), 0, 0, 'R', 0, 1);
    $pdf->Cell(15, 3, number_format($productos[$i]['pvp'], $numDecimales), 0, 0, 'C', 0, 1);
    $pdf->Cell(15, 3, number_format($productos[$i]['pvp'] * $productos[$i]['cantidad'], $numDecimales), 0, 1, 'C', 0, 1);
...
$pdf->Cell(13, 3, number_format($total, $numDecimales), 0, 1, 'R', 0, 1);
$pdf->setX(6);
$pdf->Cell(55, 3, "GRABADO : ", 0, 0, 'R', 0, 1);
$pdf->Cell(13, 3, number_format($totaIva, $numDecimales), 0, 1, 'R', 0, 1);
$pdf->setX(6);
$pdf->Cell(55, 3, "EXENTO : ", 0, 0, 'R', 0, 1);
$pdf->Cell(13, 3, number_format($totanIva, $numDecimales), 0, 1, 'R', 0, 1);
$pdf->setX(6);
$pdf->Cell(55, 3, "IVA : ", 0, 0, 'R', 0, 1);
$pdf->Cell(13, 3, number_format($ivaValor, $numDecimales), 0, 1, 'R', 0, 1);
$pdf->setX(6);
$pdf->Cell(55, 3, "TOTAL : ", 0, 0, 'R', 0, 1);
$pdf->Cell(13, 3, number_format($totaIva + $totanIva + $ivaValor, $numDecimales), 0, 1, 'R', 0, 1);
$pdf->AutoPrint(true);
$pdf->output();

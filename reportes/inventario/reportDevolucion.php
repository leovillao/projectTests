...
class reporteVentas
{
  ...
  public static function reportIngreso($id)
  {
    ...
    foreach ($ventasDet as $venta) {
      ...
      $pdf->Cell(30, $alto, number_format($venta->odcostoudig,5,'.',','), 'T,B,R', 0, 'R', 0, 0);
      $pdf->Cell(30, $alto, number_format($venta->odcostotot,5,'.',','), 'T,B,R', 1, 'R', 0, 0);
      $tttotal = $tttotal + $venta->odcostotot;
    }
    $pdf->Ln(5);
    $pdf->Cell(130, $alto, '', 0, 0, 'L', 0, 0);
    $pdf->Cell(30, $alto, 'Totales', 'L,T,B,R', 0, 'R', 0, 0);
    $pdf->Cell(30, $alto, number_format($tttotal,5,'.',','), 'T,B,R', 1, 'R', 0, 0);

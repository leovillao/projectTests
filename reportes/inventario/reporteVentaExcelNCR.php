...
//    echo json_encode($ventas);
  ...
  $spread->getActiveSheet()->getStyle('A3:J3')->getFont()->setBold(true)->setSize(10);
...
//    $hoja->setCellValueByColumnAndRow(1, 5, "Un valor en 1, 1");
  ...
  /** ======================================*/
  $hoja->setCellValueByColumnAndRow(1, 3, 'Tipo Doc');
  $hoja->setCellValueByColumnAndRow(2, 3, 'Doc');
  $hoja->setCellValueByColumnAndRow(3, 3, 'Fecha');
  $hoja->setCellValueByColumnAndRow(4, 3, 'Cliente');
  $hoja->setCellValueByColumnAndRow(5, 3, 'Exento');
  $hoja->setCellValueByColumnAndRow(6, 3, 'Grabado');
  $hoja->setCellValueByColumnAndRow(7, 3, 'Subtotal');
  $hoja->setCellValueByColumnAndRow(8, 3, 'Desc');
  $hoja->setCellValueByColumnAndRow(9, 3, 'Iva');
  $hoja->setCellValueByColumnAndRow(10, 3, 'Total');
  $i = 4;
  foreach ($ventas as $venta) {
    if ($venta->fi_tipo == "04") {
      $hoja->setCellValueByColumnAndRow(1, $i, Validacion::tipoDocumento($venta->fi_tipo));
      $hoja->setCellValueByColumnAndRow(2, $i, $venta->fi_docum);
      $hoja->setCellValueByColumnAndRow(3, $i, $venta->fi_fechadoc);
      $hoja->setCellValueByColumnAndRow(4, $i, $venta->fi_er_name);
      $hoja->setCellValueByColumnAndRow(5, $i, ($venta->fi_estado != 3) ? $venta->fi_ivasi : 0.00);
      $hoja->setCellValueByColumnAndRow(6, $i, ($venta->fi_estado != 3) ? $venta->fi_ivano : 0.00);
      $hoja->setCellValueByColumnAndRow(7, $i, ($venta->fi_estado != 3) ? $venta->fi_subtotal : 0.00);
      $hoja->setCellValueByColumnAndRow(8, $i, ($venta->fi_estado != 3) ? $venta->fi_desc : 0.00);
      $hoja->setCellValueByColumnAndRow(9, $i, ($venta->fi_estado != 3) ? $venta->fi_iva : 0.00);
      $hoja->setCellValueByColumnAndRow(10, $i, ($venta->fi_estado != 3) ? $venta->fi_neto : 0.00);
  ...
  $hoja->setCellValueByColumnAndRow(4, $i, 'TOTALES : ');
  $hoja->setCellValueByColumnAndRow(5, $i, $tiva);
  $hoja->setCellValueByColumnAndRow(6, $i, $tivan);
  $hoja->setCellValueByColumnAndRow(7, $i, $subt);
  $hoja->setCellValueByColumnAndRow(8, $i, $desc);
  $hoja->setCellValueByColumnAndRow(9, $i, $iva);
  $hoja->setCellValueByColumnAndRow(10, $i, $neto);

  $fileName = "Informe_de_Ventas_NCR_SMARTTAG_BI.xlsx";
  # Crear un "escritor"

...
//  Fecha Doc Producto Unidad Cantidad Precio Subtotal Iva Total
  ...
  $hoja->setCellValueByColumnAndRow(6, 3, 'Cantidad');
  $hoja->setCellValueByColumnAndRow(7, 3, 'Precio');
  ...
  foreach ($ventas as $venta) {
    if ($venta->fi_tipo == "04") {
      /*"fecha" => $venta->fi_fechadoc,
              ...
              "iva" => $venta->odiva,
              "neto" => $venta->fi_neto,*/
      $hoja->setCellValueByColumnAndRow(1, $i, $venta->fi_fechadoc);
      ...
      $hoja->setCellValueByColumnAndRow(4, $i, ucwords(strtolower($venta->itname)));
      $hoja->setCellValueByColumnAndRow(5, $i, $venta->undescrip);
      $hoja->setCellValueByColumnAndRow(6, $i, $venta->odcandig);
      $hoja->setCellValueByColumnAndRow(7, $i, $venta->odpvp);
      $hoja->setCellValueByColumnAndRow(8, $i, $venta->odsubtotal);
      $hoja->setCellValueByColumnAndRow(9, $i, $venta->odiva);
      $hoja->setCellValueByColumnAndRow(10, $i, $venta->odtotal);
  ...
  $fileName = "Informe_de_Ventas_ProductosNCR_SMARTTAG_BI.xlsx";
  # Crear un "escritor"

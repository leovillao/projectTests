...
foreach ($ventas as $venta) {
    ...
    if ($venta->fi_ptoemi != $emision) {
        ...
        if ($totalNeto > 0) {
            ...
            $pdf->SetFont('Arial', '', 7);
            $pdf->Cell(16, $alto, $totalivas, 'T,B,R', 0, 'R', 1, 0);
            $pdf->Cell(16, $alto, $totalivan, 'T,B,R', 0, 'R', 1, 0);
            $pdf->Cell(16, $alto, $totalSubt, 'T,B,R', 0, 'R', 1, 0);
            $pdf->Cell(16, $alto, $totalDesc, 'T,B,R', 0, 'R', 1, 0);
            $pdf->Cell(16, $alto, $totalIva, 'T,B,R', 0, 'R', 1, 0);
            $pdf->Cell(16, $alto, $totalNeto, 'T,B,R', 1, 'R', 1, 0);
...
$pdf->SetFont('Arial', '', 7);
$pdf->Cell(16, $alto, $tiva, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, $tivan, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, $subt, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, $desc, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, $iva, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, $neto, 'T,B,R', 1, 'R', 1, 0);
$pdf->Ln();

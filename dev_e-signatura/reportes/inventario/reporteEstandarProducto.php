...
if ($_POST['tipoTabla'] == "H") {
    VwinfProductosData::$tablename = "vw_informeProductosClasificacionHistoricos";
}
...
foreach ($ventas as $venta) {
    ...
    $pdf->Cell(55, $alto, ProductData::getById($venta->itid)->itcodigo.'-'.substr(utf8_decode(ucwords(strtolower($venta->itname))) . $anulado, 0, 46), 'T,B,R', 0, 'L', 0, 0);

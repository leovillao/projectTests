...
class reporteVentas
{
  ...
  public static function reportIngreso($id)
  {
    ...
    $pdf->Cell(190, 7, strtoupper(substr(TipoOperationData::getById($ventas->toid)->todescrip,2)), 0, 1, 'C', 0, 0);
    ...
    $pdf->Cell(100, $altoTitulo, 'COMENTARIO : ' . $ventas->opcomenta, 0, 0, 'L', 0, 0);
    $pdf->Cell(140, $altoTitulo, 'BOD REL : ' . BodegasData::getById($ventas->boid_transfer)->bodescrip, 0, 1, 'L', 0, 0);
    ...
    foreach ($ventasDet as $venta) {
      ...
      $pdf->Cell(30, $alto, $venta->odcostoudig, 'T,B,R', 0, 'R', 0, 0);
      $pdf->Cell(30, $alto, $venta->odcostotot, 'T,B,R', 1, 'R', 0, 0);
      $tttotal = $tttotal + $venta->odcostotot;
    }
    $pdf->Ln(5);
    $pdf->Cell(130, $alto, '', 0, 0, 'L', 0, 0);
    $pdf->Cell(30, $alto, 'Totales', 'L,T,B,R', 0, 'R', 0, 0);
    $pdf->Cell(30, $alto, $tttotal, 'T,B,R', 1, 'R', 0, 0);

...
//    $hoja->setCellValueByColumnAndRow(1, 5, "Un valor en 1, 1");
  ...
  $hoja->setCellValueByColumnAndRow(2, 3, '# Documento');
  $hoja->setCellValueByColumnAndRow(3, 3, 'Fecha');
  $hoja->setCellValueByColumnAndRow(4, 3, 'Cliente');
  $hoja->setCellValueByColumnAndRow(5, 3, 'Fecha Autorizacion');
  $hoja->setCellValueByColumnAndRow(6, 3, 'Clave Acceso');
...
//  $hoja->setCellValueByColumnAndRow(11, 3, 'Total');
  ...
  foreach ($ventas as $venta) {
    ...
    $hoja->setCellValueByColumnAndRow(5, $i, $venta->fi_fecauto);
    $hoja->setCellValueByColumnAndRow(6, $i, $venta->fi_claveAcceso);
...
//  $hoja->setCellValueByColumnAndRow(11, $i, $neto);
  $fileName = "Informe_de_Ventas_Autorizacion_SMARTTAG_BI.xlsx";
  # Crear un "escritor"

...
foreach ($secuencias as $secuencia) {
  ...
  if ($secuencia->coddoc == "01") {
    foreach ($sucursales as $sucursal) {
      ...
      $pdf->Cell(189, $alto, utf8_decode("SUCURSAL " . $sucursal->suname), 'L,T,B,R', 1, 'L', 0, 0);
      $pdf->Cell(189, $alto, utf8_decode("PUNTO EMISIÓN " . $secuencia->emision), 'L,T,B,R', 1, 'C', 0, 0);
      $ttIS = 0;
      $ttIV = 0;
      $ttS = 0;
      $ttD = 0;
...
//      $pdf->Cell(16, $altoTitulo, 'Total', 'T,B,R', 0, 'C', 0, 0);
      $pdf->Cell(25, $altoTitulo, utf8_decode('Fecha Autorización'), 'T,B,R', 0, 'C', 0, 0);
      $pdf->Cell(71, $altoTitulo, 'Clave de Acceso', 'T,B,R', 1, 'C', 0, 0);
...
//            $pdf->Cell(16, $alto, ($venta->fi_estado != 3) ? $venta->fi_neto : 0.00, 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(25, $alto, $venta->fi_fecauto, 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(71, $alto, $venta->fi_claveacceso, 'T,B,R', 1, 'R', 0, 0);
            /* ======================= Totale totales ========================*/
            if ($venta->fi_estado != 3) {
...
//      $pdf->Cell(55, $alto, 'Total sucursal ', 'T,B,R', 0, 'R', 0, 0);
//      $pdf->SetFont('Arial', '', 7);
//      $pdf->Cell(16, $alto, $ttIS, 'T,B,R', 0, 'R', 0, 0);
//      $pdf->Cell(16, $alto, $ttIV, 'T,B,R', 0, 'R', 0, 0);
//      $pdf->Cell(16, $alto, $ttS, 'T,B,R', 0, 'R', 0, 0);
//      $pdf->Cell(16, $alto, $ttD, 'T,B,R', 0, 'R', 0, 0);
//      $pdf->Cell(16, $alto, $ttI, 'T,B,R', 0, 'R', 0, 0);
//      $pdf->Cell(16, $alto, $ttT, 'T,B,R', 1, 'R', 0, 0);
    }
  }
}
...
//$pdf->Cell(23, $alto, '', 'L,T,B', 0, 'L', 0, 0);
//$pdf->Cell(15, $alto, '', 'T,B', 0, 'L', 0, 0);
//$pdf->Cell(55, $alto, 'Totales', 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $ttIvasi, 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $ttivano, 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $ttsubt, 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $ttdesct, 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $ttiva, 'T,B,R', 0, 'R', 0, 0);
//$pdf->Cell(16, $alto, $tttotal, 'T,B,R', 1, 'R', 0, 0);
$pdf->Output();

...
//    $this->Image("../../".$_SESSION['logoFooter'], 20, null, 100);
...
foreach ($Xmls->comprobante as $comprobante) {
  ...
  $pdf->Cell(64, 5, 'IDENTIFICACION COMPRADOR : ' . $xmls->infoFactura->identificacionComprador, 0, 1, 'L', 0, 1);
  ...
  for ($td = 0; $td < $totDet; ++$td) {
    ...
    $pdf->Cell(70, 5, substr(utf8_decode($xmls->detalles->detalle[$td]->descripcion),0,38) , 'R,L', 0, 'L', 0, 1);
  ...
  foreach ($xmls->infoFactura->pagos->pago as $pago) {
    switch ($pago->formaPago) {
      ...
      case 9:
        ...
        break;
      case 10:
        $pdf->Cell(100, 5, utf8_decode('TARJETA DE CRÉDITO NACIONAL'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 11:
        $pdf->Cell(100, 5, utf8_decode('TARJETA DE CRÉDITO INTERNACIONAL'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 12:
      ...
      case 13:
        ...
        break;
      case 14:
        $pdf->Cell(100, 5, utf8_decode('ENDOSO DE INVERSIÒN'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 15:
        $pdf->Cell(100, 5, utf8_decode('COMPENSACIÓN DE DEUDAS'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 16:
        $pdf->Cell(100, 5, utf8_decode('TARJETA DE DÉBITO'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 17:
        $pdf->Cell(100, 5, utf8_decode('DINERO ELECTRÓNICO'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 18:
        $pdf->Cell(100, 5, 'TARJETA PREPAGO', 'T,R,L', 0, 'L', 0, 1);
        break;
      case 19:
        $pdf->Cell(100, 5, utf8_decode('TARJETA DE CRÉDITO'), 'T,R,L', 0, 'L', 0, 1);
        break;
      case 20:

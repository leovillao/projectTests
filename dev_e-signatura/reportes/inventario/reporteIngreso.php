...
class reporteVentas
{
    ...
    public static function reportIngreso($id)
    {
        ...
        foreach ($ventasDet as $venta) {
            ...
            $pdf->Cell(20, $alto, utf8_decode(UnitData::getById($venta->unid_dig)->undescrip), 'T,B,R', 0, 'C', 0, 0);
            $pdf->Cell(30, $alto, FData::formatoNumeroReportsInventario($venta->odcandig), 'T,B,R', 0, 'R', 0, 0);

...
// Cabecera de página
    public function Header()
    {
        ...
        $this->Cell(190, 7, 'INFORME DE SALDOS', 0, 1, 'C', 0, 0);
    }
}
...
//$pdf->Cell(190, 7, "valor cero : " . $_POST['valorCero'], 0, 1, 'L', 0, 0);
    ...
    $pdf->Cell(10, $altoTitulo, '#', 'L,T,B,R', 0, 'L', 1, 0);
    $pdf->Cell(25, $altoTitulo, 'Categoria', 'T,B,R', 0, 'L', 1, 0);
    $pdf->Cell(25, $altoTitulo, 'Subcategoria', 'T,B,R', 0, 'L', 1, 0);
    $pdf->Cell(20, $altoTitulo, utf8_decode('Código'), 'T,B,R', 0, 'L', 1, 0);
    $pdf->Cell(65, $altoTitulo, 'Producto', 'T,B,R', 0, 'L', 1, 0);
    $pdf->Cell(21, $altoTitulo, 'Unidad', 'T,B,R', 0, 'C', 1, 0);
    $pdf->Cell(21, $altoTitulo, 'Saldo', 'T,B,R', 1, 'C', 1, 0);
...
/// ciclo del cuerpo del report
    foreach ($saldos as $venta) {
        ...
        $pdf->Cell(25, $alto, ucwords(strtolower($venta->ctname)), 'T,B,R', 0, 'L', 0, 0);
        $pdf->Cell(25, $alto, ucwords(strtolower($venta->ct2name)), 'T,B,R', 0, 'L', 0, 0);
        $pdf->Cell(20, $alto, $venta->itcodigo, 'T,B,R', 0, 'C', 0, 0);
        $pdf->Cell(65, $alto, ucwords(strtolower($venta->itname)), 'T,B,R', 0, 'L', 0, 0);
        $pdf->Cell(21, $alto, ucwords(strtolower($venta->undescrip)), 'T,B,R', 0, 'C', 0, 0);
        $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->saldo), 'T,B,R', 1, 'R', 0, 0);
        $ri++;
    ...
    class pdfReport
    {
        public static function reportByFechas($desde, $hasta)
        {
            ...
            $pdf->Cell(50, $altoTitulo, 'Cliente', 'T,B,R', 0, 'L', 1, 0);
            $pdf->Cell(21, $altoTitulo, 'Exento', 'T,B,R', 0, 'C', 1, 0);
            $pdf->Cell(21, $altoTitulo, 'Grabado', 'T,B,R', 0, 'C', 1, 0);
            $pdf->Cell(21, $altoTitulo, 'Subtotal', 'T,B,R', 0, 'C', 1, 0);
            $pdf->Cell(18, $altoTitulo, 'Iva', 'T,B,R', 0, 'C', 1, 0);
            $pdf->Cell(21, $altoTitulo, 'Total', 'T,B,R', 1, 'C', 1, 0);
            $pdf->SetFont('Arial', '', 7); // titulos
            $alto = 6;
            $ttIvasi = 0;
            $ttivano = 0;
            ...
            foreach ($ventas as $venta) {
                ...
                $pdf->Cell(50, $alto, ucwords(strtolower($venta->fi_er_name)), 'T,B,R', 0, 'L', 0, 0);
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_ivasi), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_ivano), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_subtotal), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(18, $alto, FData::formatoNumeroReportes($venta->fi_iva), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_neto), 'T,B,R', 1, 'R', 0, 0);
            ...
            $pdf->Cell(21, $alto, FData::formatoNumeroReportes($ttIvasi), 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(21, $alto, FData::formatoNumeroReportes($ttivano), 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(21, $alto, FData::formatoNumeroReportes($ttsubt), 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(18, $alto, FData::formatoNumeroReportes($ttiva), 'T,B,R', 0, 'R', 0, 0);
            $pdf->Cell(21, $alto, FData::formatoNumeroReportes($tttotal), 'T,B,R', 1, 'R', 0, 0);
            $pdf->Output();
        }
        ...
        public static function reportByFechasProduct($desde, $hasta)
        {
            ...
            foreach ($ventas as $venta) {
                ...
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_subtotal), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(18, $alto, FData::formatoNumeroReportes($venta->fi_iva), 'T,B,R', 0, 'R', 0, 0);
                $pdf->Cell(21, $alto, FData::formatoNumeroReportes($venta->fi_totaldoc), 'T,B,R', 1, 'R', 0, 0);
                $ttIvasi = $ttIvasi + $venta->fi_ivasi;
                $ttivano = $ttivano + $venta->fi_ivano;
                $ttsubt = $ttsubt + $venta->fi_subtotal;
                $ttiva = $ttiva + $venta->fi_iva;

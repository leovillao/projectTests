...
foreach ($cobros as $cobro) {
    if ($cobro->vencidos > 0) {
        if (empty($nameSucursal)) {
            $nameSucursal = $cobro->zoname;
        }
        if ($cobro->vencidos != $idCobro) {
            if ($totalFP > 0) {
            ...
            if ($totalNeto > 0) {
                ...
                $pdf->Cell(55, $alto, 'Subtotal Dias Vencidos ' . utf8_decode($cobro->vencidos), 'T,B,R', 0, 'R', 1, 0);
            ...
            $pdf->Cell(189, $alto, utf8_decode("Dias Vencidos : " . $cobro->vencidos), 'L,T,B,R', 1, 'L', 0, 0);
            $pdf->Cell(189, $alto, utf8_decode("CLIENTE : ") . utf8_decode($cobro->cename), 'L,T,B,R', 1, 'L', 0, 0);
...
if ($totalNeto >= 0) {
    ...
    $pdf->Cell(23, $alto, '', 'L,T,B', 0, 'L', 1, 0);
    $pdf->Cell(15, $alto, '', 'T,B', 0, 'L', 1, 0);
    $pdf->Cell(55, $alto, 'SUBTOTAL ZONA : ' . utf8_decode($nameSucursal), 'T,B,R', 0, 'R', 1, 0);
    $pdf->Cell(20, $alto, '', 'T,B,R', 0, 'R', 1, 0);
    $pdf->Cell(16, $alto, '', 'T,B,R', 0, 'R', 1, 0);
    $pdf->Cell(16, $alto, '', 'T,B,R', 0, 'R', 1, 0);
    $pdf->Cell(16, $alto, FData::formatoNumeroReportes($totalNeto), 'T,B,R', 0, 'R', 1, 0);
...
$pdf->Cell(23, $alto, '', 'L,T,B', 0, 'L', 1, 0);
$pdf->Cell(15, $alto, '', 'T,B', 0, 'L', 1, 0);
$pdf->Cell(55, $alto, 'TOTAL ' . $nameSucursal, 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(20, $alto, '', 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, '', 'T,B,R', 0, 'R', 1, 0);
$pdf->Cell(16, $alto, '', 'T,B,R', 0, 'R', 1, 0);

...
$hoja->setCellValueByColumnAndRow(1, 3, 'Cliente');
...
//    $hoja->setCellValueByColumnAndRow(1, $i, $cobro->defecha);
    $hoja->setCellValueByColumnAndRow(1, $i, ucwords(strtolower($cobro->cename)));
    ...
    $hoja->setCellValueByColumnAndRow(6, $i, $cobro->deabono);
    $hoja->setCellValueByColumnAndRow(7, $i, $cobro->desaldo);
    $hoja->setCellValueByColumnAndRow(8, $i, $cobro->devence);
    $hoja->setCellValueByColumnAndRow(9, $i, ($cobro->vencidos > 0 && $cobro->desaldo > 0)?$cobro->vencidos:'');
    $i++;
    $o++;
}
